...
`RiskGuardEnabled`, `RiskGuardAutoStop`, `RiskGuardInterval` ไม่เปลี่ยน สำหรับ tests/dev, config key อยู่ใน [dev-credentials file](../testing/dev-credentials.md) ภายใต้ `Ai`
