...
| Modifica ordine pending | Modifica l'ordine pending speculare in place |
...
- **Copia SL / Copia TP** — specchia lo stop-loss / take-profit del master, o gestisci la protezione indipendentemente.
...
- **Normalizzazione precisione SL/TP** (M6) — stop-loss/take-profit copiati arrotondati alla **precisione dei digit del simbolo di destinazione** prima della modifica, quindi il prezzo del master a precisione più fine (o mancata corrispondenza di digit cross-broker) non inciampa mai nel server `INVALID_STOPLOSS_TAKEPROFIT`.
