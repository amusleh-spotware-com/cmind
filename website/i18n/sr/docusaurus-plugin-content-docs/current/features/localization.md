...
cMind je potpuno lokalizabilan i isporucuje se u **istih 23 jezika koje cTrader sam podrzava**, so a trader
uses the platform — and reads these docs — na svom jeziku. Engleski je fallback; any missing
