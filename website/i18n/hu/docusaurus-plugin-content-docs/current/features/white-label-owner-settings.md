...
Every white-label option a deployment can set through configuration (`appsettings`/env) is **also
settable at runtime by the app owner**, from **Settings → Deployment**, without a redeploy. An owner
